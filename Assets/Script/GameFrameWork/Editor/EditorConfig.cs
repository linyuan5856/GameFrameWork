...
public class EditorConfig:ScriptableObject
{
    ...
    static private EditorConfig _Instance;
    static public EditorConfig Instance
    {
        get
        {
            if(_Instance == null)
                _Instance = (EditorConfig)AssetDatabase.LoadMainAssetAtPath(ProjectEditor.Path_EditorConfig);
            return _Instance;
        }
    }
